...
describe OrganizationsHelper do
  ...
  it "should test rendering of link_to_organization", :type => :helper do
    link_1 = %(<a title="Org A" href="/organizations/org-a">Org A</a>)
    link_2 = %(<a title="Org A/Team A" href="/organizations/org-a-team-a">Team A</a>)
    link_3 = %(<a title="Org A/Team A" href="/organizations/org-a-team-a">Org A/Team A</a>)
